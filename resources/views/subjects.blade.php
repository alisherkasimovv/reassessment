            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header" style="color: var(--bs-blue);">
                        <h4 class="modal-title">Fan qo'shish</h4>
                        ...
                        <form class="form-control">
                            <div id="theme-container" class="mb-3 mt-1">
                                <div class="form-floating">
                                    <input class="form-control" type="text" id="name" name="name" placeholder="Dars mavzusini kiriting">
                                    <label class="form-label" for="name">Fan nomi</label>
                                </div>
                            </div>
                        </form>
                    </div>
